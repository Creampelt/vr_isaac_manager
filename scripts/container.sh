...
git config --global --add safe.directory ../resources/IsaacLab/source/vr_isaaclab/
...
# take git ownership of the extension
sudo chown -R "${USER:-$(id -un)}" ../resources/IsaacLab/source/vr_isaaclab/
# turn off x11 mode
ssh_mode='"0"'
